...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2toYW5obHV1IiwiYSI6ImNqejF2cnpjZzBwYmIzZGxvMnl0ZGcxM2UifQ.9CODXiqDDccpSiexvQ6WCg';
...
// DOM ELEMENT
var mapxBox = document.getElementById('map');
var loginForm = document.querySelector('.form--login');
var logOutButton = document.querySelector('.nav__el--logout');
var updateDataForm = document.querySelector('.form-user-data');
var updatePasswordForm = document.querySelector('.form.form-user-settings');

if (mapxBox) {
  var locations = JSON.parse(mapxBox.dataset.locations);
